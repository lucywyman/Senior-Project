...
urlpatterns = [
        ...
        url(r'^assignment/submit/[0-9]+$',
            polymatheia.components.views.submit_assignment,
        ...
        url(r'^ta/create', 
            ...
            name='ta-create'),
        url(r'^ta/[a-zA-Z0-9]*$', polymatheia.components.views.ta,
            name='ta-details'),
        url(r'^ta/delete/[0-9]+$',
            polymatheia.components.views.delete_ta,
            name='ta-delete'),
        url(r'^student/add', polymatheia.components.views.student_add,
                name='student-add'),
        url(r'^student/[a-zA-Z0-9]*$', polymatheia.components.views.student,
            name='student-details'),
        url(r'^student/delete/[a-zA-Z0-9]*$',
            polymatheia.components.views.delete_student,
            name='student-delete'),
        ]
